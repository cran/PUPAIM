#' @title Langmuir Isotherm Nonlinear Analysis via selfStart and Langmuir Third Linear Model
...
SSLangmuir3analysis <- function(Ce, Qe){
  ...
  ggplot2::ggplot(data1, aes(x  = x, y = y)) + ggplot2::geom_point(color ="#3498DB" ) +
